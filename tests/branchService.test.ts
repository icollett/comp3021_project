...
describe("Branch Service", () => {
    ...
    describe("createBranch", () => {
        it("should handle successful operation", async () => {
            ...
            const result: Branch = await branchService.createBranch(testBranch);
    ...
    describe("updateBranch", () => {
        it("should handle successful operation", async () => {
            ...
            const result: Branch = await branchService.updateBranch("1", {name: "Sydney Branch", phone: "604-456-0023"});
            expect(expected).toStrictEqual(result);
        });
    });
